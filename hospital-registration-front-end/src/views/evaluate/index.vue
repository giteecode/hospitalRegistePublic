<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="evaluateList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户" align="center" prop="sysUser.nickName" />
      <el-table-column label="内容" align="center" prop="evaluateContent" />
      <el-table-column label="医生" align="center" prop="doctorNickName" />
